...
**최신 세션 기록**: `docs/next/2026-08-14/r26.md`
...
**판정 후 문안 수정 0건**, 대화형 런에서 확정 3방식(선택·위임·직접 정의)이 전부 의도대로 작동했다.
...
| **sdd·edd 산출물 판정 도구** | verify-tdd의 채택 범위는 «tdd 산출물»뿐. sdd는 specprobe(세기만 함)까지, edd는 아무것도 없다 | 미정 |
